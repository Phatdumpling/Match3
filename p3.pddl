(define (problem match2)
  (:domain Match)
  (:objects
    tile-a-1 tile-a-2 tile-a-3 tile-a-4 tile-b-1 tile-b-2 tile-b-3 tile-b-4 tile-c-1 tile-c-2 tile-c-3 tile-c-4 tile-d-1 tile-d-2 tile-d-3 tile-d-4 - tile
  )
  ...
  (:init
    ...
    (vertical tile-a-4 tile-b-4)
    (vertical tile-b-4 tile-c-4)
    (vertical tile-d-4 tile-c-4)
    


    ;(tileval tile-a-1 grif)
    (tileval tile-a-2 sly)
    (tileval tile-a-3 grif)
    (tileval tile-a-4 huff)

    (tileval tile-b-1 sly)
    (tileval tile-b-2 huff)
    (tileval tile-b-3 grif)
    (tileval tile-b-4 rav)

    (tileval tile-c-1 sly)
    (tileval tile-c-2 huff)
    (tileval tile-c-3 rav)
    (tileval tile-c-4 grif)

    (tileval tile-d-1 huff)
    (tileval tile-d-2 huff)
    (tileval tile-d-3 huff)
    (tileval tile-d-4 rav)
